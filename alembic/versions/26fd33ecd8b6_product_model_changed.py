...
Revision ID: 26fd33ecd8b6
Revises: 901fe91a5c5c
Create Date: 2024-06-18 14:48:31.809981
...
revision: str = '26fd33ecd8b6'
down_revision: Union[str, None] = '901fe91a5c5c'
...
def downgrade() -> None:
    ...
    sa.Column('retail_marks', sa.FLOAT(), nullable=True),
    sa.Column('retail_sum', sa.FLOAT(), nullable=True),
    sa.Column('nds', sa.FLOAT(), nullable=True),
    sa.Column('nds_price', sa.FLOAT(), nullable=True),
